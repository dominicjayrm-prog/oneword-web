...
export default function PromoVideo() {
  ...
  const PhoneContent = () => {
    if (bw(5800, 14700)) {
      const typingWords = ["Loudest", "sound", "nobody", "can", "hear"];
      return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flex: 1, justifyContent: "center", padding: "0 2px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "4px", padding: "3px 10px", borderRadius: "12px", backgroundColor: `${C.primary}10`, opacity: fi(6500) }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "8px", fontWeight: 600, color: C.primary }}>12 day streak</span>
          </div>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted, letterSpacing: "2.5px", textTransform: "uppercase", marginTop: "12px", opacity: fi(6800) }}>today&apos;s word</span>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "40px", fontWeight: 700, color: C.text, margin: "2px 0", letterSpacing: "-1.5px", opacity: fi(7000, 700), transform: `scale(${L(0.9, 1, easeOut(p(7000, 7700)))})` }}>SILENCE</h2>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted, opacity: fi(7500) }}>abstract · day 3</span>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted, letterSpacing: "2px", textTransform: "uppercase", marginTop: "16px", opacity: fi(8200) }}>describe it in exactly 5 words</p>
          ...
          <div style={{ marginTop: "8px", padding: "8px 20px", borderRadius: "11px", backgroundColor: at(13400) ? C.text : "#D1CCC0", width: "100%", textAlign: "center", transform: at(13800) ? "scale(1.03)" : "scale(1)", transition: "all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)" }}>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "10px", fontWeight: 700, color: "#FFF" }}>{at(13800) ? "✓ LOCKED IN" : "SUBMIT"}</span>
          </div>
        </div>
      );
    }
    ...
    if (bw(14200, 18700)) {
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flex: 1, justifyContent: "center", padding: "0 2px" }}>
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "18px", fontWeight: 700, color: C.text, opacity: fi(14800) }}>SILENCE</span>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted, letterSpacing: "2px", textTransform: "uppercase", margin: "3px 0 14px", opacity: fi(15000) }}>which is better?</span>
          <div style={{ padding: "14px 11px", borderRadius: "13px", width: "100%", backgroundColor: picked ? `${C.primary}10` : "#FFF", border: `2px solid ${picked ? C.primary : C.border}`, marginBottom: "8px", position: "relative", transform: `scale(${picked ? 1.03 : 1})`, opacity: fi(15300, 400), transition: "background-color 0.5s, border-color 0.5s, transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)" }}>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", fontWeight: 500, color: C.text, margin: 0, fontStyle: "italic", textAlign: "center" }}>&quot;Loudest sound nobody can hear&quot;</p>
            {picked && (<div style={{ position: "absolute", top: "-7px", right: "-3px", backgroundColor: C.primary, color: "white", borderRadius: "8px", padding: "2px 7px", fontSize: "7px", fontWeight: 700, fontFamily: "'DM Sans', sans-serif", opacity: fi(16800, 300), transform: `scale(${L(0.5, 1, spring(p(16800, 17200)))})` }}>YOUR PICK ✓</div>)}
          </div>
          ...
          <div style={{ padding: "14px 11px", borderRadius: "13px", width: "100%", backgroundColor: "#FFF", border: `1.5px solid ${C.border}`, marginTop: "8px", opacity: picked ? 0.25 : fi(15700, 400), transform: `scale(${picked ? 0.96 : 1})`, transition: "opacity 0.5s, transform 0.5s" }}>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "11px", fontWeight: 500, color: C.text, margin: 0, fontStyle: "italic", textAlign: "center" }}>&quot;When words take their break&quot;</p>
          </div>
          <div style={{ marginTop: "10px", display: "flex", alignItems: "center", gap: "5px", opacity: fi(15500) }}>
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "8px", color: C.muted }}>vote 7 of 15</span>
      ...
      return (
        <div style={{ display: "flex", flexDirection: "column", flex: 1, padding: "0 2px" }}>
          <div style={{ textAlign: "center", marginBottom: "6px" }}>
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "16px", fontWeight: 700, color: C.text, opacity: fi(18600) }}>SILENCE</span>
            <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "7px", color: C.muted, margin: "1px 0 0", opacity: fi(18800) }}>3,847 descriptions</p>
          </div>
          <div style={{ padding: "8px 9px", borderRadius: "11px", backgroundColor: `${C.primary}08`, border: `1.5px solid ${C.primary}`, textAlign: "center", marginBottom: "8px", opacity: fi(19200, 600), transform: `scale(${L(0.85, 1, spring(p(19200, 19800)))})` }}>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "6px", color: C.muted, textTransform: "uppercase", letterSpacing: "1px" }}>you ranked</span>
            ...
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted }}>out of 3,847</span>
          </div>
          <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "7px", color: C.muted, textTransform: "uppercase", letterSpacing: "1px", marginBottom: "4px", fontWeight: 600, opacity: fi(20200) }}>Top descriptions</span>
          {entries.map((item, i) => (
          ...
          <div style={{ marginTop: "8px", padding: "8px", borderRadius: "11px", backgroundColor: C.primary, textAlign: "center", opacity: fi(21300), transform: `scale(${L(0.9, 1, spring(p(21300, 21700)))})` }}>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "9px", fontWeight: 700, color: "#FFF" }}>📤 Share Results</span>
          </div>
        </div>
      );
    }
    ...
    >
      ...
      {bw(0, 3800) && (
        <div style={{ position: "absolute", inset: 0, zIndex: 20, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 30px", textAlign: "center", opacity: bw(2800, 3800) ? fo(2800, 700) : 1 }}>
          <p style={{ fontFamily: "'DM Sans'", fontSize: "12px", color: C.mutedLight, letterSpacing: "5px", textTransform: "uppercase", opacity: fi(200, 600), transform: `translateY(${su(200, 600, 25)}px)`, margin: "0 0 16px" }}>every single day</p>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "52px", fontWeight: 900, letterSpacing: "-2px", margin: "0", lineHeight: 1.05, opacity: fi(700, 800), transform: `translateY(${su(700, 800, 30)}px)` }}>
            <span style={{ color: C.white }}>The </span>
            <span style={{ color: C.white, textShadow: "0 0 30px rgba(255,255,255,0.25), 0 0 60px rgba(255,255,255,0.1)" }}>whole</span>
            <span style={{ color: C.white }}> world.</span>
          </h1>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "44px", fontWeight: 900, letterSpacing: "-2px", margin: "2px 0 0", lineHeight: 1.05, opacity: fi(1400, 700), transform: `translateY(${su(1400, 700, 25)}px)` }}>
            <span style={{ color: C.white }}>One </span>
            <span style={{ color: C.primary, textShadow: `0 0 30px ${C.glow}` }}>word.</span>
          </h2>
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "18px", fontWeight: 500, fontStyle: "italic", color: C.primary, margin: "16px 0 0", letterSpacing: "0.5px", opacity: fi(2100, 500) }}>Say it in five.</p>
        </div>
      )}
      ...
      {bw(3000, 6300) && (
        <div style={{ position: "absolute", inset: 0, zIndex: bw(3000, 3800) ? 15 : 20, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", opacity: bw(3000, 3800) ? fi(3000, 800) : bw(5500, 6300) ? fo(5500, 600) : 1 }}>
          {["RAIN", "LOVE", "FEAR", "PIZZA", "HOME", "WIFI"].map((w, i) => (
          ...
          <span style={{ fontFamily: "'DM Sans'", fontSize: "11px", color: C.mutedLight, letterSpacing: "4px", textTransform: "uppercase", opacity: fi(3600, 400) }}>today&apos;s word is</span>
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: `${L(24, 72, ease(p(3900, 4800)))}px`, fontWeight: 900, color: C.white, letterSpacing: "-3px", margin: "6px 0 0", lineHeight: 1, textShadow: `0 0 40px ${C.glow}, 0 0 80px ${C.glowSoft}`, opacity: fi(3900, 600) }}>SILENCE</h1>
          <p style={{ fontFamily: "'DM Sans'", fontSize: "12px", color: C.primary, fontWeight: 600, letterSpacing: "3px", textTransform: "uppercase", margin: "10px 0 0", opacity: fi(5000, 400) }}>abstract</p>
        </div>
      )}
      ...
      {bw(22000, 26500) && (
        <div style={{ position: "absolute", inset: 0, zIndex: bw(22000, 22700) ? 15 : 20, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px", opacity: bw(22000, 22700) ? fi(22000, 700) : bw(25500, 26500) ? fo(25500, 700) : 1 }}>
          <p style={{ fontFamily: "'DM Sans'", fontSize: "11px", color: C.mutedLight, letterSpacing: "3px", textTransform: "uppercase", margin: "0 0 14px", opacity: fi(22500, 400) }}>share your result</p>
          <div style={{ width: "100%", maxWidth: "300px", padding: "24px 20px", borderRadius: "22px", background: `linear-gradient(145deg, ${C.dark1} 0%, ${C.dark2} 100%)`, textAlign: "center", boxShadow: `0 25px 80px rgba(0,0,0,0.6), 0 0 60px ${C.glow}`, opacity: fi(22800, 600), transform: `translateY(${su(22800, 700, 30)}px) scale(${L(0.92, 1, easeOut(p(22800, 23500)))})` }}>
            ...
            <span style={{ fontFamily: "'DM Sans'", fontSize: "7px", color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: "2px" }}>today&apos;s word</span>
            <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "36px", fontWeight: 700, color: "#FFF", margin: "2px 0 12px", letterSpacing: "-1.5px" }}>SILENCE</h3>
            <div style={{ padding: "10px 12px", borderRadius: "12px", backgroundColor: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", marginBottom: "14px" }}>
              <p style={{ fontFamily: "'DM Sans'", fontSize: "14px", fontWeight: 500, color: "#FFF", margin: 0, fontStyle: "italic" }}>&quot;Loudest sound nobody can hear&quot;</p>
            </div>
            <div style={{ display: "flex", justifyContent: "center", gap: "16px" }}>
              {[{ icon: "📊", value: "#7", label: "RANK" }, { icon: "❤️", value: "694", label: "VOTES" }, { icon: "🔥", value: "12", label: "STREAK" }].map((s, i) => (
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "14px", fontStyle: "italic", color: C.primary, opacity: 0.7, marginTop: "16px" }}>How would you describe it?</p>
        </div>
      )}
      ...
      {at(26000) && (
        <div style={{ position: "absolute", inset: 0, zIndex: 25, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 30px", opacity: fi(26000, 800) }}>
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontStyle: "italic", color: C.primary, margin: "0 0 6px", textAlign: "center", letterSpacing: "0.5px", opacity: fi(27500, 500) }}>Say it in five.</p>
          <p style={{ fontFamily: "'DM Sans'", fontSize: "13px", color: "rgba(255,255,255,0.3)", margin: "0 0 4px", textAlign: "center", opacity: fi(27800, 500) }}>The daily game for creative minds.</p>
          ...
          <div style={{ padding: "16px 44px", borderRadius: "16px", backgroundColor: C.primary, boxShadow: `0 8px 40px ${C.glow}`, opacity: fi(28500, 600), transform: `scale(${L(0.85, 1, spring(p(28500, 29200)))})` }}>
            <span style={{ fontFamily: "'DM Sans'", fontSize: "18px", fontWeight: 700, color: "#FFF" }}>Play Now — Free</span>
          </div>
          <p style={{ fontFamily: "'DM Mono'", fontSize: "10px", color: "rgba(255,255,255,0.15)", marginTop: "14px", opacity: fi(29500, 500) }}>Join thousands of daily players</p>
      ...
      {!on && (
        <div style={{ position: "absolute", inset: 0, zIndex: 100, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,0.85)", backdropFilter: "blur(16px)", borderRadius: "20px" }}>
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", color: C.primary, fontSize: "12px", margin: "0 0 6px", opacity: 0.8 }}>Say it in five.</p>
          <p style={{ fontFamily: "'DM Sans'", color: "rgba(255,255,255,0.35)", fontSize: "11px" }}>Tap to play · 33s</p>
        </div>
      )}
